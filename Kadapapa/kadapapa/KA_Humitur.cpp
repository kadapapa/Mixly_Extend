 ...
 *   None
 */
KA_Humiture::KA_Humiture(void) : KA_Port(0)
{
	_port = 0;
}
 ...
 */
KA_Humiture::KA_Humiture(uint8_t port) : KA_Port(port)
{
	_DataPin = s1;
	_port = port;
}
 ...
 *   None
 */
void KA_Humiture::setpin(uint8_t port)
{
	_DataPin = port;
	s1 = _DataPin;
	_port = port;
 ...
 *   None
 */
void KA_Humiture::reset(uint8_t port)
{
	KA_Port::reset(port);
}
 ...
 *   None
 */
uint8_t KA_Humiture::getPort(void)
{
  return(_port);
}
 ...
 *   None
 */
uint8_t KA_Humiture::getHumidity(void)
{
	return Humidity;
}
 ...
 *   None
 */
uint8_t KA_Humiture::getTemperature(void)
{
	return Temperature;
}
 ...
 *   None
 */
uint8_t KA_Humiture::getValue(uint8_t index)
{
//	update();		
	if(index == 1)
	{
 ...
 *    None
 */
double KA_Humiture::getFahrenheit(void)//Celsius degrees to Fahrenheit
{
 ...
 *    None
 */
double KA_Humiture::getKelvin(void)
{
 ...
 *    None
 */
double KA_Humiture::getdewPoint(void)
{
 ...
 *    None
 */
double KA_Humiture::getPointFast()
{
	double a = 17.271;
	double b = 237.7;
