...
/**
 * Alternate Constructor which can call your own function to map the KA_Gyro to arduino port,
 * no pins are used or initialized here
 */
KA_Gyro::KA_Gyro(void) : KA_Port(0)
{
 ...
 */
KA_Gyro::KA_Gyro(uint8_t port) : KA_Port(port)
{
  Device_Address = GYRO_DEFAULT_ADDRESS;
}
 ...
 */
KA_Gyro::KA_Gyro(uint8_t port, uint8_t address) : KA_Port(port)
{
 ...
 */
void KA_Gyro::setpin(uint8_t AD0, uint8_t INT)
{
  _AD0 = AD0;
  _INT = INT;
 ...
 *   None
 */
uint8_t KA_Gyro::getDevAddr(void)
{
 ...
 *   Z-axis angle value is integral of Z-axis angular velocity.
 */
double KA_Gyro::getAngle(uint8_t index)
{
  update();
  if(index == 1)
  {
 ...
 */
void KA_Gyro::deviceCalibration(void)
{
//  int8_t return_value;
  uint16_t x = 0;
  uint16_t num = 500;
 ...
 */
int8_t KA_Gyro::writeReg(int16_t reg, uint8_t data)
{
 ...
 */
int8_t KA_Gyro::readData(uint8_t start, uint8_t *buffer, uint8_t size)
{
  int16_t i = 0;
  int8_t return_value = 0;
 ...
 */
int8_t KA_Gyro::writeData(uint8_t start, const uint8_t *pData, uint8_t size)
{
  int8_t return_value = 0;
  Wire.beginTransmission(Device_Address);
  return_value = Wire.write(start); 
