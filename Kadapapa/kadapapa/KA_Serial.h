 ...
 * @version V1.0.1
 * @date    2015/01/20
 * @brief   Header for for KA_Serial.cpp module
 *
 * \par Copyright
 ...
 * </pre>
 */
#ifndef __KA_SERIAL_H
#define __KA_SERIAL_H
 ...
 * Class: KA_Serial
 * \par Description
 * Declaration of Class KA_Serial.
 */


class KA_Serial : public KA_Port//, public SoftwareSerial
{
public:
/**
 ...
 */
//  KA_Serial(uint8_t receivePin, uint8_t transmitPin, bool inverse_logic = false);
  KA_Serial(uint8_t receivePin, uint8_t transmitPin);
