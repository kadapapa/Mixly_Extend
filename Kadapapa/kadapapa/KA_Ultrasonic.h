 ...
 * @file    KA_Ultrasonic.h
 * @author  MakeBlock
 * @version V1.0.1
 * @date    2016/06/25
 * @brief   Header for for KA_Ultrasonic.cpp module
 *
 * \par Copyright
 ...
 * </pre>
 */
#ifndef __KA_ULTRASONIC_H
#define __KA_ULTRASONIC_H
 ...
 * Class: KA_Ultrasonic
 * \par Description
 * Declaration of Class KA_Ultrasonic.
 */

class KA_Ultrasonic : public KA_Port
{
public:
