 ...
 * @version V1.0.1
 * @date    2016/04/07
 * @brief   Header for KA_DCMotor.cpp module
 *
 * \par Copyright
 ...
 *
 */
#ifndef __KA_DCMOTOR_H
#define __KA_DCMOTOR_H
 ...
 * Class: KA_DCMotor
 * \par Description
 * Declaration of Class KA_DCMotor
 */

class KA_DCMotor : public KA_Port
{
public:
/**
 ...
 */
  KA_DCMotor(uint8_t dir_pin,uint8_t pwm_pin);
